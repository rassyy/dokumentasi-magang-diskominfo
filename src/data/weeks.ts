...
export const WEEKS: Week[] = [
  ...
  },
  {
    id: 'minggu-5',
    number: 5,
    title: 'Laporan Implementasi Hermes 9Router, Skema Backup, Monitoring & LibreNMS',
    subtitle: 'Implementasi AI agent, skema backup server Proxmox, sistem monitoring dan monitoring jaringan',
    status: 'completed',
    categories: ['ai-agent', 'backup', 'monitoring'],
    summary: 'Pelaporan implementasi lengkap AI agent Hermes 9Router pada lingkungan Proxmox, perancangan dan implementasi skema backup restore aplikasi dan LXC server Proxmox dengan sinkronisasi offsite ke Google Drive, pembangunan sistem monitoring server, virtual machine (CT), Docker, dan device jaringan menggunakan stack Prometheus dan Grafana, serta pembangunan sistem monitoring jaringan menggunakan LibreNMS dengan integrasi protokol SNMP.',
    activities: [
      ...
      { title: 'Validasi fungsional AI agent melalui respons dan log aktivitas.' },
      ...
      { title: 'Instalasi dan konfigurasi sistem monitoring jaringan LibreNMS beserta penambahan perangkat MikroTik melalui SNMP.' },
    ],
    documents: ['laporan-hermes-9router', 'skema-backup-restore', 'monitoring-server-prometheus-grafana', 'monitoring-jaringan-librenms'],
  },
];
